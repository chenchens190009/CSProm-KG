...
class ICEWS05_15_Processor(Processor):
    ...
    def create_ent2id_rel2id_entid2name_relid2name(self):
        train_lines = self.read_file('icews_2005-2015_train.txt')
        valid_lines = self.read_file('icews_2005-2015_valid.txt')
        test_lines = self.read_file('icews_2005-2015_test.txt')
    ...
    def check_descrip(self):
        for entid, entname in self.entid2name.items():
            if entid not in self.entid2descrip:
                self.entid2descrip[entid] = ' '
...
processor = ICEWS05_15_Processor(in_folder, out_folder, dataset)
processor.create_out_folder()
processor.create_ent2id_rel2id_entid2name_relid2name()
for year in range(2005, 2016):
    processor.create_entid2descrip(str(year) + '.tab')
processor.check_descrip()
...
in_files = ['icews_2005-2015_train.txt', 'icews_2005-2015_valid.txt', 'icews_2005-2015_test.txt']
